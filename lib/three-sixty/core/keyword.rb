  ...
  module Core
    class Keyword
      ...
      def get_info_by_id(keyword_id)
        client_request(resource_url("getInfoById"), id: keyword_id)
      end

      def get_status_by_id_list(keyword_ids)
        client_request(resource_url("getStatusByIdList"), idList: keyword_ids)
      end

      def get_info_by_id_list(keyword_ids)
        client_request(resource_url("getInfoByIdList"), idList: keyword_ids)
      end
